...
_sage_const_3 = Integer(3); _sage_const_65 = Integer(65); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_8 = Integer(8); _sage_const_16 = Integer(16); _sage_const_33 = Integer(33); _sage_const_32 = Integer(32)#!/usr/bin/env sage
...
List_instances=[twostepinstance(_sage_const_3 ,_sage_const_6 ,_sage_const_16 ,_sage_const_32 ),twostepinstance(_sage_const_3 ,_sage_const_8 ,_sage_const_16 ,_sage_const_32 ),twostepinstance(_sage_const_3 ,_sage_const_5 ,_sage_const_33 ,_sage_const_65 )]

List_data=['phi_matrix_elements_H']
